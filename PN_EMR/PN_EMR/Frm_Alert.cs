...
namespace PN_EMR
{
    public partial class Form_Alert : Form
    {
        ...
        public void showAlert(string msg, enmType type)
        {
            ...
            var point = new Point(12, 13);
            switch (type)
            {
                
                case enmType.Success:
                    //this.pic_Success.Image = Resources.success;
                    pic_Success.Visible = true;
                    pic_Success.Location = point;
                    this.BackColor = Color.SeaGreen;
                    break;
                case enmType.Error:
                    this.pic_Error.Visible = true;
                    pic_Error.Location = point;
                    this.BackColor = Color.DarkRed;
                    break;
                case enmType.Info:
                    this.pic_Info.Visible = true;
                    pic_Info.Location = point;
                    this.BackColor = Color.RoyalBlue;
                    break;
                case enmType.Warning:
                    this.pic_Warning.Visible = true;
                    pic_Warning.Location = point;
